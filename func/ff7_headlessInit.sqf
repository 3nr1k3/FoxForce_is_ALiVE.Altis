...
if (!isServer) then
{
	...
	{
/*		["Headless", (format ["ALiVE Server version   : %1", _alive_server_ver])] call FF7_fnc_debugLog;
		["Headless", (format ["ALiVE Headless version : %1", _alive_client_ver])] call FF7_fnc_debugLog;

		["Headless", "ALiVE version missmatch, sending client back to lobby"] call FF7_fnc_debugLog;
*/
