...
[
	[_ttdWeapon,	["WeaponHolder", "GroundWeaponHolder", "WeaponHolderSimulated", "WeaponHolder_Single_F", "WeaponHolder_Single_limited_item_F", "WeaponHolder_Single_limited_magazine_F", "WeaponHolder_Single_limited_weapon_F"]],
	[_ttdDemo,		["TimeBombCore"]],
	[_ttdOther,		["SmokeShell"]],
	[_ttdOther,		["CraterLong_small", "CraterLong"]],
	[_ttdOther,		["ACE_Track", "ACE_Wheel", "ACE_SandbagObject", "ACE_Tactical_Ladder", "ACE_TripodObject", "ace_fastroping_helper"]],
	[_ttdOther,		["#dynamicsound", "#destructioneffects", "#track", "#particlesource"]]
];
