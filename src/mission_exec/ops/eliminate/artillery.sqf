...
private ["_faction", "_facSide", "_unitEng", "_unitOff", "_vehAA", "_vehArty"];
...
_posOK	= false;
_msg	= "Find the and elimitnate the enemy artillery units";
...
while {!_posOK} do
{
	...
	{
		_objPos = [_marker, 500, 15, 0.35] call OPS_fnc_getPosFromMarker;
...
switch (_faction) do
{
	...
	{
		_facSide	= east;
		_unitEng	= "O_engineer_F";
		_unitOff	= "O_officer_F";
		_vehAA		= "O_APC_Tracked_02_AA_F";
		_vehArty	= "O_MBT_02_arty_F";
	};

	case "CSAT_P":
	{
		_facSide	= east;
		_unitEng	= "O_T_Engineer_F";
		_unitOff	= "O_T_Officer_F";
		_vehAA		= "O_T_APC_Tracked_02_AA_ghex_F";
		_vehArty	= "O_T_MBT_02_arty_ghex_F";
	};

	case "AAF":
	{
		_facSide	= resistance;
		_unitEng	= "I_engineer_F";
		_unitOff	= "I_officer_F";
		_vehAA		= "O_APC_Tracked_02_AA_F";
		_vehArty	= "O_MBT_02_arty_F";
	};
};
