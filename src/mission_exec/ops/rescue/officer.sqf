private ["_posOK", "_marker", "_location", "_objPos", "_objOrg", "_posOff" ,"_objOff", "_grpOff", "_hmgs", "_objThings", "_objSpawned", "_objEnemy", "_relPos", "_rndDir", "_offEH"];
...
/*
_offEH = _objOff addEventHandler
[
	"Killed",
	{
