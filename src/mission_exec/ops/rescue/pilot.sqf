private ["_posOK", "_marker", "_location", "_objPos", "_objOrg", "_posPilot" ,"_objPilot", "_grpPilot", "_hmgs", "_objThings", "_objSpawned", "_objEnemy", "_relPos", "_rndDir", "_pilotEH"];

private ["_faction", "_facSide", "_empUnit"];
...
/*
_pilotEH = _objPilot addEventHandler
[
	"Killed",
	{
		...
		if (isPlayer _killer) then
		{
			...
			//[(format ["<t align='center'><t size='2.0' color='#CC2222'>R.O.E</t><br/><br/><t size='1.3' color='#00B2EE'>Watch your fire <t size='1.3' color='#CC2222'>%1</t>,<br/>you just killed the %2!</t>", _nameKiller, "pilot"]), 15] remoteExec ["FF7_fnc_globalHint", 0];
			["ROE", "R.O.E", (format ["Watch your fire <t color='#CC2222'>%1</t>,<br/>you just killed the %2 !</t>", _nameKiller, "pilot"])] remoteExec ["FF7_fnc_globalHintStruct", 0];
		};
	}
];
*/
