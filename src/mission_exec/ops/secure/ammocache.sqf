private ["_posOK", "_marker", "_location", "_objPos", "_stuffPos", "_objCache", "_objTent", "_objThings", "_rndDir", "_objSpawned"];
...
//_objTent enableSimulation false;
...

{
	...
	_tmpObj = [_x, _objTent, _rndDir] call _spawnRel;
