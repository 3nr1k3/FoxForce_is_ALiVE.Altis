private ["_delay", "_completeLimit", "_opType", "_popType", "_actOp", "_prevOp"];

private ["_gatherOps", "_destroyOps", "_eliminateOps", "_secureOps", "_rescueOps"];
...
_destroyOps		= ["druglab", "radar", "radiotower", "factory"];
_secureOps		= ["blackfoot", "c130", "blackhawk", "ammocache"];
_eliminateOps	= ["mortar", "anti-air", "artillery"];
_rescueOps		= ["pilot", "officer"]; // "hostage"
